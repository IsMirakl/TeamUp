...
import (
	...
	appGetAuthorPost "backend/internal/content/application/query/get_author_post"
...
type Handler struct {
	service *appGetAuthorPost.Service
	log     *logrus.Logger
}

func NewHandler(service *appGetAuthorPost.Service, log *logrus.Logger) *Handler {
